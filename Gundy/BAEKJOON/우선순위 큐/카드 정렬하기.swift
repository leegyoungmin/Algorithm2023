...
var minimumHeap = Heap<(Int)>(condition: <)

for _ in 1...Int(readLine()!)! {
    minimumHeap.insert(Int(readLine()!)!)
}

var result = 0

while minimumHeap.count > 1 {
    var mergedCards = minimumHeap.remove()!
    mergedCards += minimumHeap.remove()!
    result += mergedCards
    minimumHeap.insert(mergedCards)
}
